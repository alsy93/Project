function [t, y, collectorBank, collectortime] = integrator_MOD113_0(y0,time,par)
% This function provides to evaluate the Time step of the integrator ODE113
...
% Consider a default max step

disp('==================================================================');
disp('ODE113 evaluations with a default Max step size ');

options = odeset('OutputFcn',@myOutputFcn,'RelTol',1e-13,'AbsTol',1e-13,'NormControl','on','Stats','on',...
                 'Events',@h_event);

[t1,y1]= ode113(@Mechanicalsystm,time,y0,options,par);
