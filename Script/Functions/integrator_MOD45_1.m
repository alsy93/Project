function [t45_1, y45_1, bank45,timebank45] = integrator_MOD45_1(y0,time,par)
tic
...
%1) With a set Max step size
options1 = odeset('OutputFcn',@myOutputFcn,'RelTol',1e-13,'AbsTol',1e-13,'NormControl','on','Stats','on',...
                 'Events',@h_event,'MaxStep',0.3);             
         
disp('=================================================================='); 
disp('ODE45 evaluations with a Max step set at 0.3');             
[t45_1,y45_1]= ode45(@Mechanicalsystm,time,y0,options1,par);
bank45 = collectorBank;
timebank45 = collectortime;
Integrator_timeODE45 = toc;
fprintf('Run time of integration with a Max step size 0.3 is %d.\n',Integrator_timeODE45);
